...
int main()
{
    ...
    float oldV = Joystick::getAxisPosition(0, Joystick::V);
    ...
    while (window.isOpen())
    {
        ...
        if (gameState == 1)
        {
            ...
            player2.setPosition((windowWidth / 2) + Joystick::getAxisPosition(0, Joystick::U) * circleSize, (windowHeight / 2) + Joystick::getAxisPosition(0, Joystick::V) * circleSize);
        ...
        if (frame % 3 == 0)
        {
            ...
            graphRightY.update(-Joystick::getAxisPosition(0, Joystick::V));
            ...
            graphRightAccX.update(oldV - Joystick::getAxisPosition(0, Joystick::V));
        }
        ...
        if (gameState == 0)
        {
            ...
            Vector2f bluCoords((windowWidth / 2) + Joystick::getAxisPosition(0, Joystick::U) * circleSize, (windowHeight / 2) + Joystick::getAxisPosition(0, Joystick::V) * circleSize);
        ...
        oldV = Joystick::getAxisPosition(0, Joystick::V);
